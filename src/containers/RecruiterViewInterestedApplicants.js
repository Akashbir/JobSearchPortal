...
export default class RecruiterViewInterestedApplicants extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount() {
        this.recruiterService.getInterestedApplicants().then(applicants => {
            this.setState({
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-md-12">
                        <img className="img-fluid w-100" src ="https://picsum.photos/id/378/1200/300"/>
                    </div>
                </div>
                <div>
